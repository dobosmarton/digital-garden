...
tags:
  ...
  - ethereum
  - web3
description: "How to build an Ethereum wallet app with React Native"
status: published
series:
  order: 1
...
```js showLineNumbers title="src/navigation/index.tsx"
...
```ts showLineNumbers title="src/navigation/bottomTab.tsx"
...
...
```ts showLineNumbers title="src/components/bottomTabBar.tsx"
...
...
```ts showLineNumbers title="src/screens/CreateWallet.tsx"
...
...
```ts showLineNumbers title="src/screens/RestoreWallet.tsx"
...
...
```ts showLineNumbers title="src/context/account.provider.tsx"
