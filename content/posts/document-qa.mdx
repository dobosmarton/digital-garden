...
tools:
  - slug: uploadthing
    note: "The S3 wrapper handling file uploads — free tier + typed SDK"
  - slug: llamaindex-ts
    note: "RAG orchestration: PDF parsing, embeddings, vector indexing in one"
  - slug: qdrant
    note: "The vector DB choice over Pinecone — HTTP API + setup"
  - slug: vercel-ai-sdk
    note: "Streams AsyncIterables into ReadableStreams for real-time chat"
  - slug: zod
    note: "Runtime message validation beyond TS compile time"
  - slug: shadcn-ui
    note: "Headless primitives for the chat interface"
status: published
---
