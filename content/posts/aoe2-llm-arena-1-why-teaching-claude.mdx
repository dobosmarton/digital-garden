...
tools:
  - slug: ultralytics-yolo
    note: "The detection framework — readers will want to see the model/training API"
  - slug: pyautogui
    note: 'The "how does it actually move the mouse" answer'
  - slug: anthropic-prompt-caching
    note: "The 90% cost cut hinges on this — the doc backs the claim"
status: published
series:
  order: 1
