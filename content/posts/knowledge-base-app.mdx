...
tools:
  - slug: llamaindex-python
    note: "Python RAG: parsing, embeddings, VectorStoreIndex queries"
  - slug: chromadb
    note: "Open-source vector DB in server mode — the self-hosted RAG alternative"
  - slug: minio
    note: "S3-compatible doc store — how to avoid AWS lock-in"
  - slug: bge-embeddings
    note: "Local HF embedding model vs OpenAI embeddings"
  - slug: fastapi
    note: "Async endpoints with dependency injection"
  - slug: poetry
    note: "Dependency management replacing pip"
status: published
---
