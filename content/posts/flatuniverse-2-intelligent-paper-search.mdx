...
tools:
  - slug: pinecone
    note: "FilterOperator.GTE/LTE on publish dates → time-aware search"
  - slug: openai-gpt4o-mini
    note: "Temporal query analysis + final response generation"
  - slug: llamaindex-ts
    note: "Retrieval, reranking, streaming chat engine"
  - slug: vercel-ai-sdk
    note: "Streams responses to the Next.js frontend"
status: published
series:
  order: 2
