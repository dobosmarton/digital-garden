...
tools:
  - slug: web3js
    note: "signTransaction / sendSignedTransaction / estimateGas"
  - slug: etherscan
    note: "Verify Ethereum transaction receipts"
  - slug: polygonscan
    note: "Verify MATIC transactions on Mumbai"
  - slug: polygon-faucet
    note: "Fund a test address with MATIC to try sends"
  - slug: infura
    note: "Gas price, nonce, and broadcast across both networks"
status: published
series:
  order: 3
