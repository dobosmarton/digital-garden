...
tools:
  - slug: mastra
    note: "The agent framework: read-only explore → plan → implement on approval"
  - slug: plane
    note: "API the agents drive to move tasks through workflow states"
  - slug: telegram-bot-api
    note: "The phone-first interface turning natural language into agent instructions"
status: published
---
