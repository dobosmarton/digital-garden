...
tools:
  - slug: web3js
    note: "web3LibBuilder pattern serving both Ethereum and Polygon RPC"
  - slug: react-native-pager-view
    note: "Swipeable currency cards at native performance"
  - slug: polygon
    note: "Why one wallet supporting an L2 + L1 matters"
  - slug: infura
    note: "Now multi-network: Ethereum + Polygon (Mumbai) endpoints"
  - slug: react-native-reanimated
    note: "Pager-driven animated pagination dots"
status: published
series:
  order: 2
